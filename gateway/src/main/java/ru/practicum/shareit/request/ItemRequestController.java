...
public class ItemRequestController {
    ...
    public ResponseEntity<Object> createItemRequest(
            ...
            @Valid @RequestBody ItemRequestShortDtoGW itemRequestShortDtoGW
    ) {
    ...
    public ResponseEntity<Object> getItemRequestListByUser(
        ...
        log.warn("List<ItemRequestDtoGW> getItemRequestList (@RequestHeader(X-Sharer-User-Id) Long {}", userId);
    ...
    public ResponseEntity<Object> getItemRequestById(
        ...
        log.warn("List<ItemRequestDtoGW> getItemRequestList (@RequestHeader(X-Sharer-User-Id) Long {}, @PathVariable Long {})",
                userId, requestId);
